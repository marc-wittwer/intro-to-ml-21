...
if use_features:
    train_features = pd.read_csv('data/train_features_interpolated_use_features.csv')
    train_labels = pd.read_csv('data/train_labels.csv')
    test_features = pd.read_csv('data/test_features_interpolated_use_features.csv')
else:
...
reg = MultiOutputRegressor(linear_model.LinearRegression(), n_jobs=n_jobs)  # lots of parameters that could be set here
reg.fit(X, y)
