...
if __name__ == "__main__":
    ...
    if use_features:
        train_features.to_csv('data/train_features_interpolated_use_features.csv', index=True)
        test_features.to_csv('data/test_features_interpolated_use_features.csv', index=True)
    else:
